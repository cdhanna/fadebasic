...
namespace FadeBasic
{
    ...
    public static class ErrorCodes
    {
        ...
        public static readonly ErrorCode CommandOverloadAmbiguous = "[0291] the argument types match more than one overload of this command equally well — the call is ambiguous";
